...
class administrator extends App{
	...
	function main(){
		...
		return $this->View->toString(TEMPLATE_DOMAIN_DASHBOARD .'apps/administrator-home.html');
	}
	...
	function users(){
		...
		$this->assign('users',$res); 
		return $this->View->toString(TEMPLATE_DOMAIN_DASHBOARD .'widgets/administrator-user-lists.html');
	}
	 
	function roles(){
	
	 
		return $this->View->toString(TEMPLATE_DOMAIN_DASHBOARD .'widgets/administrator-roles-lists.html');
	}
	...
	function addroles(){
		...
		if($addroles==1){
			...
			return $this->View->toString(TEMPLATE_DOMAIN_DASHBOARD .'widgets/create-user-roles.html');
		}
	}
	...
	function doregister(){
		...
		if($doregistration==1){
			...
			return $this->View->toString(TEMPLATE_DOMAIN_DASHBOARD .'widgets/create-user.html');
		}
	}
	...
	function edit(){
		...
		return $this->View->toString(TEMPLATE_DOMAIN_DASHBOARD .'widgets/edit-user.html');
	}
	...
	function unusers(){
		...
		sendRedirect( $CONFIG['DASHBOARD_DOMAIN']."administrator/users");
	...
	function seepermission(){
		...
		$this->assign('users',$res);
		return $this->View->toString(TEMPLATE_DOMAIN_DASHBOARD .'widgets/administrator-user-permission.html');
	}
	...
	function addpermissionuser(){
		...
		return $this->View->toString(TEMPLATE_DOMAIN_DASHBOARD .'widgets/add-permission-user.html');
	}
	...
	function modulepermissionlist(){
		...
		return $this->View->toString(TEMPLATE_DOMAIN_DASHBOARD .'widgets/module-permission-list.html');
	}
	
	function modulespermissionform(){
	
		return $this->View->toString(TEMPLATE_DOMAIN_DASHBOARD .'widgets/add-modules.html');
	}
