...
if(preg_match("/dev./i",$_SERVER['HTTP_HOST'])){
	$DOMAIN = "http://{$_SERVER['HTTP_HOST']}/heinekentags/";
	$PUBLIC_HTML = "";
}else{
	$DOMAIN = "http://{$_SERVER['HTTP_HOST']}/heinekentags/";
	$PUBLIC_HTML = "public_html/";
}
$CONFIG['BASE_DOMAIN_PATH'] = "http://preview.kanadigital.com/heinekentags/";
...
$CONFIG['LOCAL_PUBLIC_ASSET'] = "/home/kana/kanadigital/preview/heinekentags/public_html/public_assets/";

$CONFIG['LOCAL_ASSET'] = "/home/kana/kanadigital/preview/heinekentags/public_html/assets/";
...
$CONFIG['SESSION_NAME'] = "heinekentags-2014_apps_2014";
...
$CONFIG['DATABASE_WEB'] = "heinekentags";
...
//SOCIAL MEDIA
//testing
$FB['appID'] = "604438376271887"; 
$FB['appSecret'] = "b1d705a88c5c01a0f6f23b46163a4035";
...
$CONFIG['DATABASE_WEB'] = "heniken_video_social";
...
if($local){
	...
	$CONFIG['DATABASE']['MSSQL'][0]['DATABASE'] 	=  $CONFIG['DATABASE_WEB'];
}else{
